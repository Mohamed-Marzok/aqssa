document.addEventListener("DOMContentLoaded", () => {
  ...
  const ampmSelect = document.getElementById(
    "ampm-select"
  ) as HTMLSelectElement;
  const setAlarmButton = document.getElementById(
    "set-alarm"
  ...
  const alertOkButton = document.getElementById(
    "alert-ok-button"
  ) as HTMLButtonElement;
  ...
  const alarmTimeDisplay = document.getElementById(
    "alarm-time-display"
  ) as HTMLElement;
